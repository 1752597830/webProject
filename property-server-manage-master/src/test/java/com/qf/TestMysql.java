...
public class TestMysql {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("qinfeng")
                .setOutputDir("E:\\code\\Java\\webProject\\property-server-manage-master\\src\\main\\java")//设置输出路径
        ...
        packageConfig.setParent("com.qf").setMapper("mapper")
